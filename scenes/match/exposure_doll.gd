...
func _draw() -> void:
	...
	if ghillie:
		...
		draw_circle(Vector2(cx, h * 0.30), 20.0 * s, Color("3d6a28"))
		draw_circle(Vector2(cx - 12.0 * s, h * 0.18), 11.0 * s, Color("5a8f34"))
		draw_circle(Vector2(cx + 12.0 * s, h * 0.20), 10.0 * s, Color("7cb34a"))
		draw_circle(Vector2(cx, h * 0.10), 10.0 * s, Color("6aa03a"))
		draw_circle(Vector2(cx + 1.0 * s, h * 0.32), 9.0 * s, skin)
		draw_rect(Rect2(cx - 4.0 * s, h * 0.28, 3.0 * s, 3.0 * s), Chrome.INK)
		draw_rect(Rect2(cx + 2.4 * s, h * 0.28, 3.0 * s, 3.0 * s), Chrome.INK)
		draw_rect(Rect2(cx - 16.0 * s, h * 0.40, 32.0 * s, 30.0 * s), Color("4a8f32"))
		draw_circle(Vector2(cx - 15.0 * s, h * 0.44), 8.0 * s, Color("5a8f34"))
		draw_circle(Vector2(cx + 15.0 * s, h * 0.46), 7.5 * s, Color("7cb34a"))
		draw_circle(Vector2(cx, h * 0.50), 7.0 * s, Color("3d6a28"))
	else:
		## Teal hoodie kid — lobby-canon plate.
		draw_rect(Rect2(cx - 14.0 * s, h * 0.08, 28.0 * s, 10.0 * s), hair)
		draw_rect(Rect2(cx - 12.0 * s, h * 0.09, 24.0 * s, 6.0 * s), Color("3d2618"))
		draw_circle(Vector2(cx, h * 0.26), 13.0 * s, skin)
		draw_rect(Rect2(cx - 13.0 * s, h * 0.17, 26.0 * s, 6.0 * s), teal_l)
		draw_rect(Rect2(cx - 2.4 * s, h * 0.18, 5.0 * s, 4.0 * s), Color.WHITE)
		draw_rect(Rect2(cx - 5.0 * s, h * 0.24, 3.2 * s, 3.2 * s), Chrome.INK)
		draw_rect(Rect2(cx + 2.4 * s, h * 0.24, 3.2 * s, 3.2 * s), Chrome.INK)
		if bandana:
			draw_rect(Rect2(cx - 14.0 * s, h * 0.19, 28.0 * s, 7.0 * s), Color("c45a4a"))
			draw_rect(Rect2(cx + 11.0 * s, h * 0.24, 7.0 * s, 9.0 * s), Color("c45a4a"))
		draw_rect(Rect2(cx - 16.0 * s, h * 0.36, 32.0 * s, 28.0 * s), teal)
		draw_rect(Rect2(cx - 12.0 * s, h * 0.38, 24.0 * s, 10.0 * s), teal_l)
		draw_circle(Vector2(cx, h * 0.46), 5.5 * s, skin)
		draw_circle(Vector2(cx - 7.0 * s, h * 0.42), 2.4 * s, Color.WHITE)
