...
## Placeholder in-fiction names (Josh may rename). No OEM / mil-sim copy.
...
const GUN_SLOT := "gun"
const GUN_STARTER_OWNED_COPY := "Starter  ·  on the rack"
const GUN_LOCKED_COPY := "Locked  ·  gun SKU later"
...
static func gun_family_hint(item_id: String) -> String:
	match canonical_gun_id(item_id):
		GUN_RAILFRAME:
			return "Chassis bolt"
		GUN_CRESCENT:
