...
| **A2** reconnect | **PASS LIVE** (this smoke) | `LIVE_A2_SMOKE_OK` — see below. Mock: `HEADLESS_LOOP_OK` `_a2_reconnect_case`. Still: [`ux/a2_reconnect_server_snapshot.png`](ux/a2_reconnect_server_snapshot.png) (if captured) |
...
Mock unit: `godot --headless --path . -s res://tools/headless_loop_test.gd` → `_a2_reconnect_case`.
