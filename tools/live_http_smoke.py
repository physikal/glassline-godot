...
def main() -> int:
    ...
    if int(seated.get("status") or 0) == 201:
    ...
    expect(str(created.get("seat", "a")) == "a", "create seat a")
    ...
    expect(join_a.get("seat") == "a", "join seat a", str(join_a.get("error", join_a.get("seat"))))
